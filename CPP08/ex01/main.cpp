...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/05/12 13:46:34 by romvan-d          #+#    #+#             */
/*   Updated: 2025/05/12 13:46:56 by romvan-d         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(void) {
    ...
    try {
        ...
        spanInstance.addMultiple(startRandomVector, endRandomVector);
    }
    catch (std::exception &e) {
        std::cout << e.what() << std::endl << std::endl;
    }
    ...
    Span bigSpan(30000);
    bigSpan.addMultiple(startRandomVector, endRandomVector);
